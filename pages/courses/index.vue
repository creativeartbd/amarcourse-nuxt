...
<script setup>
useSeoMeta({
    title: "Course With Sidebar || Histudy - Online Courses & Education Vue 3 Nuxtjs Template",
...
// let getAllCourse = JSON.parse(JSON.stringify(CourseDetails.courseDetails.slice(0, 12)));
let getAllCourse = courses.value.data.posts;
...
const getSelectedCourse = computed(() => filtered.value.slice((page.value - 1) * 6, (page.value - 1) * 6 + 6));
