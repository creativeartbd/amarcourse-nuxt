            ...
            <div class="rbt-tutor-information">
              <div class="rbt-tutor-information-left">
                <div class="thumbnail rbt-avatars size-lg position-relative">
                  <nuxt-img src="/images/team/avatar-2.jpg" alt="Instructor" />
          ...
          >
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
              <div class="filter-select rbt-modern-select">
                <label htmlFor="displayname" class="">
...
<script setup>
const textareaText = ref(`I'm the Front-End
      Developer for #Rainbow IT in Bangladesh, OR. I have serious passion for UI
