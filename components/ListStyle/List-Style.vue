    ...
    <div class="row g-5">
      <div class="col-lg-6 col-md-12 col-12">
        <ul class="rbt-list-style-1">
          ...
          <li>
            <i class="feather-check"></i>Have an intermediate skill level of.
          </li>
          <li>
            <i class="feather-check"></i>Have a portfolio of various data.
          </li>
    ...
    <div class="row g-5 mt--40">
      ...
      <div class="col-lg-6 col-md-6 col-12">
        <ul class="rbt-list-style-3">
          ...
          <li><i class="feather-edit-2"></i> Visual and Creative Arts</li>
          <li>
            <i class="feather-battery-charging"></i> Thinking and Learning
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="col-lg-6">
        <div class="rbt-feature-wrapper">
          ...
          <div class="rbt-feature feature-style-1">
            ...
            <div class="feature-content">
              <h6 class="feature-title">Experienced Teachers service.</h6>
              <p class="feature-description">
