        ...
        <div class="rbt-contact-form contact-form-style-1 max-width-auto">
            ...
            <form @submit.prevent="handleLogin" class="max-width-auto">
                <div class="form-group">
                    <input v-model="loginForm.email" name="con_name" type="text" placeholder="Username or email *" />
    ...
    <div class="col-lg-6">
        <div class="rbt-contact-form contact-form-style-1 max-width-auto">
            ...
            <form @submit.prevent="handleSubmit" class="max-width-auto">
                <div class="form-group">
                    <input v-model="form.email" name="register-email" type="email" placeholder="Email address *" />
                    <span v-if="errors.email" class="error">{{ errors.email }}</span>
                    <span class="focus-border"></span>
                </div>

                <div class="form-group">
                    <input v-model="form.username" name="register_user" type="text" placeholder="Username *" />
                    <span v-if="errors.username" class="error">{{ errors.username }}</span>
                    <span class="focus-border"></span>
                </div>

                <div class="form-group">
                    <input v-model="form.password" name="register_password" type="password" placeholder="Password *" />
