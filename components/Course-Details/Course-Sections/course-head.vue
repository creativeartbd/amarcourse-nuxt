<template>
    <div v-if="path.includes('/course-details-2/')" class="container">
        <div class="row">
    ...
    <template v-else>
        ...
        <div class="container">
            <div class="row">
                <CourseBreadcrumb :courseHeadData="courseHeadData" :getMatchCourse="checkMatch && checkMatch" />
            </div></div
    ></template>
</template>
...
defineProps(["checkMatch", "courseHeadData"]);
</script>
